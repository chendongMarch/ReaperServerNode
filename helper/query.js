...
exports.lucky = function (limit, callback) {
    var db = getDb();
    authority(db, callback, function auth() {
        openColl(db, 'album_whole', callback, function (collection) {
...
exports.checkVersion = function (callback) {
    var db = getDb();
    authority(db, callback, function auth() {
        openColl(db, 'version', callback, function (collection) {
...
exports.addUser = function (username, pwd, callback) {
    var db = getDb();
    authority(db, callback, function auth() {
        openColl(db, 'userinfo', callback, function (collection) {
...
exports.getWholeAlbumScanData = function (colName, offset, limit, callback) {
    var db = getDb();
    authority(db, callback, function auth() {
        openColl(db, colName, callback, function (collection) {
...
exports.getDetails = function (albumlink, offset, limit, callback) {
    var db = getDb();
    authority(db, callback, function auth() {
        openColl(db, 'album_detail', callback, function (collection) {
